## Разработка магазина «Guitar Shoр».
...
Реализована пагинация для страницы каталога.  
Страница карточки товара.
Реализована превью карточки товара для каталога.  
...
Клонировать проект git clone https://github.com/Olvenn/Guitar-Shop.git  
